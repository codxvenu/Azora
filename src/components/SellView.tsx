...
<div className="text-center space-y-3">
  ...
  <p className="text-sm text-zinc-600 font-medium dark:text-zinc-400">
    Directly register digital licenses, vouchers, or keys onto AURA global pool standard.
      ...
      {/* Selling Form Card */}
      <div className="rounded-[1.5rem] p-6 sm:p-8 border border-zinc-200/50 dark:border-zinc-900 space-y-6 shadow-2xl transition-all duration-300 bg-white shadow-zinc-200/30 dark:bg-zinc-950/40 dark:shadow-black">
  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
    <div className="space-y-1">
      <label className="text-[10px] font-mono font-bold uppercase tracking-widest text-zinc-500">
        Asset / Brand Template
      </label>
      <input
        type="text"
        value={brand}
        ...
        className="w-full p-3.5 rounded-xl outline-none font-medium text-sm border transition-colors bg-zinc-50/60 border-zinc-100 focus:border-zinc-300 text-zinc-900 dark:bg-zinc-900/60 dark:border-zinc-800 dark:focus:border-zinc-700 dark:text-white"
      />
    </div>
  ...
  <div className="space-y-2 text-left">
    ...
    <textarea
      ...
      className="w-full h-64 p-5 rounded-2xl outline-none transition-all font-mono text-xs border leading-relaxed bg-[#fafafa] border-zinc-100 focus:ring-1 focus:ring-black focus:bg-white text-zinc-900 dark:bg-zinc-900 dark:border-zinc-800 dark:text-amber-100 dark:focus:ring-1 dark:focus:ring-zinc-700 dark:focus:bg-zinc-900/80"
    />
  </div>

  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
    <div className="p-4 rounded-xl text-left flex items-start gap-3 transition-colors duration-300 bg-zinc-100/30 dark:bg-zinc-900/40 dark:text-zinc-400">
      ...
      <div>
        ...
        <p className="text-[10px] leading-relaxed">
          Our smart validators parse, normalize, and match your license numbers
          instantly against official databases.
        </p>
      </div>
    </div>
    ...
    <div className="p-4 rounded-xl text-left flex items-start gap-3 transition-colors duration-300 bg-zinc-100/30 dark:bg-zinc-900/40 dark:text-zinc-400">
      ...
      <div>
        <p className="font-bold text-xs text-zinc-800 dark:text-zinc-200">
          Merchant Safety escrow
        </p>
        <p className="text-[10px] leading-relaxed">
          Payments are credited directly to your digital ledger wallet
          immediately upon buyer checkout validation.
        </p>
      </div>
    </div>
  </div>
  ...
  <button
    ...
    className="w-full py-4.5 rounded-xl font-mono text-xs font-bold uppercase tracking-widest hover:scale-[1.01] active:scale-[0.99] transition-all disabled:opacity-30 bg-black text-white hover:bg-zinc-900 dark:bg-white dark:text-zinc-950 dark:hover:bg-zinc-100"
  >
  ...
  <div>
    <h3 className="text-xl font-display font-black tracking-tight uppercase flex items-center gap-2">
      ...
      Stock Volume Statistics
    </h3>

    <p className="text-xs text-zinc-600 font-medium dark:text-zinc-400">
      Live status of your registered stock pool inventory & verification
      status.
    </p>
  </div>

  <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
    <div className="p-5 rounded-2xl border bg-white border-zinc-200/50 text-zinc-900 dark:bg-zinc-950/20 dark:border-zinc-900 dark:text-white">
      <p className="text-[10px] font-mono tracking-wider font-bold uppercase text-zinc-500 dark:text-zinc-400">
        Total Listings
      </p>
      ...
      <p className="text-[8px] font-mono uppercase mt-1 text-zinc-400 dark:text-zinc-500">
        Pool requests
      </p>
    </div>
    ...
    <div className="p-5 rounded-2xl border bg-white border-zinc-200/50 text-zinc-900 dark:bg-zinc-950/20 dark:border-zinc-900 dark:text-white">
      ...
      <p className="text-2xl font-black font-mono tracking-tight text-amber-600 dark:text-amber-500 mt-1">
        {totalCodesLive}
      </p>
    ...
    <div className="p-5 rounded-2xl border bg-white border-zinc-200/50 text-zinc-900 dark:bg-zinc-950/20 dark:border-zinc-900 dark:text-white">
      ...
      <p className="text-2xl font-black font-mono tracking-tight mt-1">
        ${totalPayoutPending.toFixed(2)}
      </p>

      <p className="text-[8px] font-mono text-amber-600 dark:text-amber-500 font-bold uppercase mt-1">
    ...
    <div className="p-5 rounded-2xl border bg-white border-zinc-200/50 text-zinc-900 dark:bg-zinc-950/20 dark:border-zinc-900 dark:text-white">
      ...
      <p className="text-2xl font-black font-mono tracking-tight text-emerald-600 dark:text-emerald-500 mt-1">
        ${totalEarnedApproved.toFixed(2)}
      </p>

      <p className="text-[8px] font-mono text-emerald-600 dark:text-emerald-500 font-bold uppercase mt-1">
        {approvedCount} Liquidated items
      </p>
    </div>
  </div>
</div>
  ...
  {isLoadingSubmissions ? (
    ...
    <div className="py-12 text-center rounded-2xl border border-dashed bg-zinc-50/50 border-zinc-200 text-zinc-400 dark:bg-zinc-950/10 dark:border-zinc-900 dark:text-zinc-500">
      <Database className="w-8 h-8 mx-auto text-zinc-500/40 mb-3" />
      <p className="text-sm font-bold">Seller session inactive</p>
      <p className="text-xs max-w-sm mx-auto mt-1">
        Please sign in to register as a merchant and manage your pool
        storage.
      </p>
    </div>
    ...
    <div className="py-12 text-center rounded-2xl border border-dashed bg-zinc-50/50 border-zinc-200 text-zinc-400 dark:bg-zinc-950/10 dark:border-zinc-900 dark:text-zinc-500">
      ...
      <p className="text-xs max-w-sm mx-auto mt-1">
        Enter codes above and click "List in AURA Pool" to see your
        inventory manifest here.
      </p>
    </div>
  ) : (
    <div className="rounded-2xl border overflow-hidden bg-white border-zinc-200/55 dark:bg-zinc-950/10 dark:border-zinc-900">
      <div className="overflow-x-auto">
        <table className="w-full text-left border-collapse font-mono text-xs">
          <thead>
            <tr className="border-b font-mono font-black uppercase text-[9px] tracking-wider text-zinc-400 bg-zinc-50/60 border-zinc-200/40 dark:bg-zinc-900/30 dark:border-zinc-900">
              ...
              >
                ...
                <td className="p-4 text-center">
                  <button
                    ...
                    className="p-1.5 rounded-lg border hover:bg-red-500/10 hover:border-red-500/30 text-zinc-500 hover:text-red-500 transition-colors bg-zinc-50 border-zinc-200 dark:bg-zinc-900 dark:border-zinc-800"
